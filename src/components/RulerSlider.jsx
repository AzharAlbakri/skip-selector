...
export default function RulerSlider({ onSelectSkip }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-6 p-6">
            ...
            <div
                className={`flex gap-6 w-full max-w-4xl border rounded-xl p-4 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.01] ${!activeSkip.allowed_on_road || !activeSkip.allows_heavy_waste ? 'opacity-50 pointer-events-none' : ''
                    }`}
            >

                <div className="relative w-96 h-60 overflow-hidden rounded-xl shadow-md flex-shrink-0">
        ...
        ${imageLoaded ? 'opacity-100 scale-100 z-20' : 'opacity-0 scale-95 z-0'}`}
                ...
                <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div>
                        <button
                            onClick={() => onSelectSkip(activeSkip)}
